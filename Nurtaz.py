...
logo='''
\033[1;94m ┈┈┈┈╱▔▔▔▔╲┈┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈┈╱▔▔▔▔╲┈┈┈┈
\033[1;94m ┈┈┈▕▕Nurtaz▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕Nurtaz M4▏▏┈┈┈
\033[1;94m ┈┈┈▕▕▂╱╲▂▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕▂╱╲▂▏▏┈┈┈
\033[1;94m ┈┈┈┈╲┊┊┊┊╱┈┈┈┈\033[1;94mShabirBaloch.\033[1;91m┈┈┈┈╲┊┊┊┊╱┈┈┈┈
\033[1;96m ┈┈┈┈▕╲▂▂╱▏┈┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈┈▕╲▂▂╱▏┈┈┈┈
\033[1;96m ╱▔▔▔▔┊┊┊┊▔▔▔▔╲☞☞☞☞☞☞\033[1;91m☜☜☜☜☜╱▔▔▔▔┊┊┊┊▔▔▔▔╲
\033[1;96m................\033[1;93mNurtaz\033[1;91m...............
\033[1;96m................\033[1;93m✬🄵🄰🄲🄴🄱🄾🄾🄺✬\033[1;91m..............

\033[1;96m░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░

\033[1;91m☞ Auther     : Termux Nurtaz
\033[1;92m☞ WhatsApp   : 01829420557
\033[1;95m☞ YouTube    : https://youtube.com/@opgameryt023
...
def login():
	...
	try:
		...
		print
		id=termuxnurtaz(S + '[☆] ' + S + 'Email: ' + G +'')
		pwd=termuxnurtaz=(S + '[♡] ' + R + 'Password : ')
...
def menu():
	...
	cb()
	print (logo)
	print (S + '[☆] ' + G + 'ID Name: TermuxNurtaz
	print (S + '[☆] ' + G + 'User ID: termuxnurtaz
	print
	print (S + 50*'-')
	print
	print (S + '[' + P + '☞1' + S + ']' + S + ' Fast Cloning New Update')
	print (S + '[' + P + '☞2' + S + ']' + S + ' Update Nurtaz_BALOCH Tool')
	print (S + '[' + P + '☞3' + S + ']' + S + ' Nurtaz_BALOCH WhatsApp Group')
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('rm -rf $HOME/Nurtaz_BALOCH')
	    ...
	    psb('WellCome To Nurtaz_BALOCH')
	    psb('Congratulations Nurtaz_BALOCH Tool Has Been Updated Successfully')
	    psb('🔓User Name☆ 786786✓')
	    psb('🔓Password ☆ 786786✓')
	    psb('Subscrib My Youtube Channel Nurtaz BALOCH M4 MASTER✓')
	    psb('Please Login Again')
	    time.sleep(2)
	    os.system('cd $HOME/Nurtaz_BALOCH && python2 Nurtaz.py')
	elif bm =='3':
